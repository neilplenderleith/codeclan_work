...
Answered above - it does seem to make a difference. the median also seems to return whole numbers whereas the mean returns a number with 4 decimal places
